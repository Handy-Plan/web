...
const fieldInput =
  "h-12 w-full rounded-xl border border-line bg-surface pl-11 pr-4 text-[15px] text-ink shadow-[var(--shadow-subtle)] transition-colors placeholder:text-muted focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/25";
...
export default async function SignupPage({ params, searchParams }: PageProps) {
  ...
  return (
    <main className="min-h-svh lg:grid lg:grid-cols-[1fr_1.05fr]">
      {/* ── Form panel ───────────────────────────────────────────── */}
      <div className="relative order-2 flex min-h-svh flex-col bg-canvas lg:order-1">
            ...
            <form action={signup} className="flex flex-col gap-5">
              ...
              <label className="flex cursor-pointer items-start gap-2.5 text-sm text-graphite">
                <input
                  ...
                  name="terms"
                  required
                  className="mt-0.5 h-4 w-4 rounded border-line accent-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                />
                <span>{t("terms")}</span>
              </label>
      ...
      <aside className="relative order-1 hidden flex-col justify-between overflow-hidden bg-gradient-to-bl from-primary via-indigo to-violet p-10 text-white lg:order-2 lg:flex xl:p-14">
        {/* decorative layers */}
        <div
          aria-hidden
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute -bottom-24 -right-16 h-80 w-80 rounded-full bg-violet/30 blur-3xl"
        />
        ...
        {/* bottom: trust stat */}
        <div className="relative flex items-center gap-3 rounded-2xl bg-white/10 p-5 ring-1 ring-inset ring-white/15 backdrop-blur-sm">
          ...
          <p className="text-sm font-medium text-white/90">{t("brand.stat")}</p>
        </div>
      </aside>
    </main>
  );
