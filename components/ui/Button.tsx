...
const variants: Record<Variant, string> = {
  primary:
    "bg-gradient-to-br from-primary to-indigo text-white shadow-[0_4px_14px_rgba(99,102,241,0.35)] hover:-translate-y-0.5 hover:shadow-[var(--shadow-glow)] hover:brightness-[1.05]",
  secondary:
